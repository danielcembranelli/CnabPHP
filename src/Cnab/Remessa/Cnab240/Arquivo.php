...
class Arquivo implements \Cnab\Remessa\IArquivo
{
    ...
    public function configure(array $params)
    {
        ...
        //$this->codigo_banco == \Cnab\Banco::CEF || 
        if ($this->codigo_banco == \Cnab\Banco::SANTANDER) {
            //$this->headerArquivo->codigo_cedente = $this->configuracao['codigo_cedente'];
            $this->headerArquivo->codigo_transmissao = $this->configuracao['codigo_transmissao'];
        }
        ...
        if ($this->codigo_banco == \Cnab\Banco::SANTANDER) {
            ...
            $this->headerLote->codigo_transmissao = $this->configuracao['codigo_transmissao'];
    ...
    public function formatarNossoNumero($nossoNumero)
    {
        ...
        switch($this->codigo_banco){
            ...
            $resto2 = $this->mod11($nossoNumero, 9, 1);
            $digito = 11 - $resto2;
